...
def checkIfDetailedVertexesAreAllowed(vertexList, allowedDetailedProductionList, testResultList):
    """
    ...
    :param testResultList: reference for test list
    """
    ...
    for x in vertexList:
        if(x.prodType == detailedProductionType):
            isDetailedProductionAllowed(x.content,allowedDetailedProductionList, testResultList)





def isDetailedProductionAllowed(production, detailedProductionList, testResultList):
    """
...
def readEdgesAndVertexFromXml(drawingFileLocation, vertexListToFill, edgeListToFill, edgeDictToFill, mainStoryPropsToFill, testResultList, notAllowedShapesList):
    ...
    :param testResultList: list to store test results
...
def checkOutgoingEdgesCorrectness(vertexDict,edgeDict,testResultList):
    ...
    :param vertexDict
    :param edgeDict
    :param testResultListist of Vertex entities to verify
    """
    endingProductionType = "ending"
...
def dfsToEnding(vertexDict, edgeDict, visitedIdList, foundEnding, currentVertexId):
    ...
    # print(currentVertexId,vertexDict.get(currentVertexId))
