...
allowedDetailedProductionList = loadFromJson("./"+sys.argv[2])
...
checkProductionTypesByRegex(vertexList,testResultList) # nadaje typ produkcji udok

checkVertexListColors(vertexList,testResultList,allowedColorDictionary)

checkIfDetailedVertexesAreAllowed(vertexList,allowedDetailedProductionList,testResultList)
